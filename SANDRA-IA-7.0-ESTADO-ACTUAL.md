...
```bash
npx netlify-cli env:set HEYGEN_API_KEY "M2IzYzcyOGY1ZmFhNGI5YmE5NzBlZTFiNDhmOTc3MDMtMTc1MzU4MDA1OA=="
```
...
### .env Local (.gitignore):
```bash
# ⚠️ EXAMPLE CONFIGURATION - NEVER COMMIT REAL API KEYS
# Set actual credentials in your local .env file (which is in .gitignore)
